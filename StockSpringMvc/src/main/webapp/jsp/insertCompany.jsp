...
<div class="container-fuild">
        ...
        <form class="form-horizontal">
            <div class="Absolute-Center is-Responsive">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2">CEO Name & Board Members</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2">IPO date</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="IpoDate">
                    </div>
                </div>
                <div class="form-group">
